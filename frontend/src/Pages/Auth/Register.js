    ...
    <div style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <Row>
        <h1 className="text-center ">
          ...
          <FontAwesomeIcon icon={faRegistered} style={{color: "#FFD43B",}} />
        </h1>
        {/* <h1 className="text-center " style={{color:'yellow'}}>Welcome to Fitness System</h1> */}
        <Col md={{ span: 6, offset: 3 }}>
          <h2 className=" text-center mt-5" style={{color:'yellow'}}>Registration</h2>
          <Form>
