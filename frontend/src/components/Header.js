...
import i from "../assets/pngtree-fitness-equipment-dumbbell-barbell-image_1339351-removebg-preview.png";
const Header = () => {
  ...
  return (
    ...
    <Navbar className="navbarCSS" collapseOnSelect expand="lg" style={{position: 'relative', zIndex: "2 !important"}}>
      {/* <Navbar className="navbarCSS" collapseOnSelect expand="lg" bg="dark" variant="dark"> */}
        <Navbar.Brand href="/" className="text-white navTitle"> <img src={i} style={{height:'70px'}}></img>Fitness</Navbar.Brand>
        <Navbar.Toggle
